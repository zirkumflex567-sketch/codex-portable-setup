...
- Use `spawn_agent`, `wait_agent`, and `close_agent` for the explorer, architect, test, and review agents it describes.
- Follow the surrounding Codex instructions if they conflict with this skill's approval flow.
